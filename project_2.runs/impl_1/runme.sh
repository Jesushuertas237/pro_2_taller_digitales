...
HD_PWD='C:/ultima/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prueba_wrapper.tcl -notrace
