...
HD_PWD='C:/ultima/project_2/project_2.runs/prueba_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_axi_smc_0.tcl
