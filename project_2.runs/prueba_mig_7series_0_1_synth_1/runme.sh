...
HD_PWD='C:/ultima/project_2/project_2.runs/prueba_mig_7series_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_mig_7series_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_mig_7series_0_1.tcl
