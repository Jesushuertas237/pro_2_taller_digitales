...
HD_PWD='C:/ultima/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_wrapper.tcl
