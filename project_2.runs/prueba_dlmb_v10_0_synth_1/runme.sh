...
HD_PWD='C:/ultima/project_2/project_2.runs/prueba_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_dlmb_v10_0.tcl
