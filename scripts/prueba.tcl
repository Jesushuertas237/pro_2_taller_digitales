...
################################################################
# This is a generated script based on design: prueba
#
...
proc write_mig_file_prueba_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>prueba_mig_7series_0_0</ModuleName>}
   ...
   puts $mig_prj_file {    <selected>7a/xc7a15ti-csg324</selected>}
   puts $mig_prj_file {    <selected>7a/xc7a35ti-csg324</selected>}
   puts $mig_prj_file {    <selected>7a/xc7a50ti-csg324</selected>}
   puts $mig_prj_file {    <selected>7a/xc7a75ti-csg324</selected>}
...
# End of write_mig_file_prueba_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  set sd_reset [ create_bd_port -dir O -from 0 -to 0 -type data sd_reset ]
  ...
  write_mig_file_prueba_mig_7series_0_0 $str_mig_file_path
  ...
  # Create instance: top_vga_0, and set properties
  set top_vga_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:top_vga:1.0 top_vga_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports dip_switches_16bits] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports dip_switches_16bits_0] [get_bd_intf_pins axi_gpio_3/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins top_vga_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M06_AXI [get_bd_intf_pins axi_smc/M06_AXI] [get_bd_intf_pins axi_gpio_2/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M07_AXI [get_bd_intf_pins axi_smc/M07_AXI] [get_bd_intf_pins axi_gpio_3/S_AXI]
  ...
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins top_vga_0/clk_25]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net const_0_dout [get_bd_pins const_0/dout] [get_bd_ports sd_reset]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_riscv_0_Clk [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_riscv_0/Clk] [get_bd_pins microblaze_riscv_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins top_vga_0/clk] [get_bd_pins top_vga_0/S_AXI_ACLK] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk]
  connect_bd_net -net mig_7series_0_init_calib_complete [get_bd_pins mig_7series_0/init_calib_complete] [get_bd_pins axi_gpio_0/gpio2_io_i]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins axi_smc/aclk1] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in] [get_bd_pins clk_wiz_1/resetn]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins top_vga_0/S_AXI_ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_reset [get_bd_pins rst_clk_wiz_1_100M/peripheral_reset] [get_bd_pins top_vga_0/reset]
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn] [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net top_vga_0_VGA_B [get_bd_pins top_vga_0/VGA_B] [get_bd_ports VGA_B_0]
  connect_bd_net -net top_vga_0_VGA_G [get_bd_pins top_vga_0/VGA_G] [get_bd_ports VGA_G_0]
  connect_bd_net -net top_vga_0_VGA_HS [get_bd_pins top_vga_0/VGA_HS] [get_bd_ports VGA_HS_0]
  connect_bd_net -net top_vga_0_VGA_R [get_bd_pins top_vga_0/VGA_R] [get_bd_ports VGA_R_0]
  connect_bd_net -net top_vga_0_VGA_VS [get_bd_pins top_vga_0/VGA_VS] [get_bd_ports VGA_VS_0]
  ...
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs top_vga_0/S_AXI/reg0] -force
