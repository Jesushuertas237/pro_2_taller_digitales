...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_mig_7series_0_78M, and set properties
  set rst_mig_7series_0_78M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_mig_7series_0_78M ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins mig_7series_0/S_AXI]
  ...
  connect_bd_net -net rst_mig_7series_0_78M_peripheral_aresetn  [get_bd_pins rst_mig_7series_0_78M/peripheral_aresetn] \
