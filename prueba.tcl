...
proc write_mig_file_prueba_mig_7series_0_1 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>prueba_mig_7series_0_1</ModuleName>}
...
# End of write_mig_file_prueba_mig_7series_0_1()
...
proc create_root_design { parentCell } {
  ...
  write_mig_file_prueba_mig_7series_0_1 $str_mig_file_path
  ...
  [get_bd_pins top_vga_0/clk] \
  [get_bd_pins top_vga_0/S_AXI_ACLK]
  ...
  connect_bd_net -net top_vga_0_VGA_B  [get_bd_pins top_vga_0/VGA_B] \
  [get_bd_ports VGA_B_0]
  connect_bd_net -net top_vga_0_VGA_G  [get_bd_pins top_vga_0/VGA_G] \
  [get_bd_ports VGA_G_0]
  connect_bd_net -net top_vga_0_VGA_HS  [get_bd_pins top_vga_0/VGA_HS] \
  [get_bd_ports VGA_HS_0]
  connect_bd_net -net top_vga_0_VGA_R  [get_bd_pins top_vga_0/VGA_R] \
  [get_bd_ports VGA_R_0]
  connect_bd_net -net top_vga_0_VGA_VS  [get_bd_pins top_vga_0/VGA_VS] \
  [get_bd_ports VGA_VS_0]
